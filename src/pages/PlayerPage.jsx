...
export default function PlayerPage() {
  ...
  useEffect(() => {
    ...
    if (streamUrl) {
      setChannel({ id: channelId, nombre: nombre || 'Canal', stream_url: streamUrl, estado: 'activo' })
      setLoading(false)
    } else {
      ...
      <div style={{ display: 'grid', gridTemplateColumns: '1fr 320px', gap: '1.5rem' }}>
        <div>
          <div style={{ borderRadius: 12, overflow: 'hidden', background: '#000' }}>
            <VideoPlayer
              streamUrl={channel.stream_url || 'http://localhost:5000/api/proxy/stream?cid=' + channel.id}
          ...
          <div style={{ padding: '1.5rem 0' }}>
            ...
            <div style={{ display: 'flex', gap: '0.75rem', flexWrap: 'wrap', marginBottom: '1rem' }}>
              ...
              {channel.categoria && <span style={{ color: '#888', fontSize: '0.85rem' }}>{channel.categoria}</span>}
