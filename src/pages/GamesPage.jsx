...
const GAMES = {
  ...
  snes: [
    ...
    { name: 'Super Mario Kart',            rom: `${R2}/snes/Super Mario Kart (USA).zip`,                                                         cover: `${R2}/snes/covers/supermariokart.jpg` },
    { name: 'Super Mario RPG',             rom: `${R2}/snes/Super Mario RPG - Legend of the Seven Stars (USA).zip`,                              cover: `${R2}/snes/covers/supermariarpg.jpg` },
    { name: "Yoshi's Island",              rom: `${R2}/snes/Super Mario World 2 - Yoshi's Island (USA).zip`,                                     cover: `${R2}/snes/covers/yoshisisland.jpg` },
    { name: 'Super Mario All-Stars',       rom: `${R2}/snes/Super Mario All-Stars (USA).zip`,                                                    cover: `${R2}/snes/covers/supermarioallstars.jpg` },
    { name: 'Zelda Link to the Past',      rom: `${R2}/snes/Legend of Zelda, The - A Link to the Past (USA).zip`,                                cover: `${R2}/snes/covers/zelda.jpg` },
    { name: 'Donkey Kong Country',         rom: `${R2}/snes/Donkey Kong Country (USA) (Rev 2).zip`,                                              cover: `${R2}/snes/covers/dkc.jpg` },
    ...
    { name: 'Super Street Fighter II',     rom: `${R2}/snes/Super Street Fighter II (USA).zip`,                                                  cover: `${R2}/snes/covers/supersf2.jpg` },
    { name: 'Street Fighter Alpha 2',      rom: `${R2}/snes/Street Fighter Alpha 2 (USA).zip`,                                                   cover: `${R2}/snes/covers/sfealpha2.jpg` },
    { name: 'Mortal Kombat',               rom: `${R2}/snes/Mortal Kombat (USA) (Rev 1).zip`,                                                    cover: `${R2}/snes/covers/mortalkombat.jpg` },
    ...
    { name: 'Chrono Trigger',              rom: `${R2}/snes/Chrono Trigger (USA).zip`,                                                           cover: `${R2}/snes/covers/chronotrigger.jpg` },
    { name: 'Final Fantasy II',            rom: `${R2}/snes/Final Fantasy II (USA) (Rev 1).zip`,                                                 cover: `${R2}/snes/covers/ff2.jpg` },
    ...
    { name: 'Mega Man X',                  rom: `${R2}/snes/Mega Man X (USA) (Rev 1).zip`,                                                       cover: `${R2}/snes/covers/megamanx.jpg` },
    ...
    { name: 'Star Fox',                    rom: `${R2}/snes/Star Fox (USA) (Rev 2).zip`,                                                         cover: `${R2}/snes/covers/starfox.jpg` },
    { name: 'Star Fox 2',                  rom: `${R2}/snes/Star Fox 2 (USA).zip`,                                                               cover: '' },
    { name: 'F-Zero',                      rom: `${R2}/snes/F-Zero (USA).zip`,                                                                   cover: `${R2}/snes/covers/fzero.jpg` },
    { name: 'EarthBound',                  rom: `${R2}/snes/EarthBound (USA).zip`,                                                               cover: `${R2}/snes/covers/earthbound.jpg` },
    { name: 'Super Metroid',               rom: `${R2}/snes/Super Metroid (USA).zip`,                                                            cover: '' },
    { name: 'Pilotwings',                  rom: `${R2}/snes/Pilotwings (USA).zip`,                                                               cover: `${R2}/snes/covers/pilotwings.jpg` },
    { name: 'ActRaiser',                   rom: `${R2}/snes/ActRaiser (USA).zip`,                                                                cover: `${R2}/snes/covers/actraiser.jpg` },
    { name: 'Super Punch-Out!!',           rom: `${R2}/snes/Super Punch-Out!! (USA).zip`,                                                        cover: `${R2}/snes/covers/superpunchout.jpg` },
    ...
    { name: 'NBA Jam',                     rom: `${R2}/snes/NBA Jam (USA) (Rev 1).zip`,                                                          cover: `${R2}/snes/covers/nbajam.jpg` },
    { name: 'NBA Jam Tournament Edition',  rom: `${R2}/snes/NBA Jam - Tournament Edition (USA).zip`,                                             cover: `${R2}/snes/covers/nbajamte.jpg` },
    { name: 'WWF Royal Rumble',            rom: `${R2}/snes/WWF Royal Rumble (USA).zip`,                                                         cover: `${R2}/snes/covers/wwfroyalrumble.jpg` },
    { name: 'Super Bomberman',             rom: `${R2}/snes/Super Bomberman (USA).zip`,                                                          cover: `${R2}/snes/covers/superbomberman.jpg` }, 
  ],
 neogeo: [
    { name: 'Metal Slug',              rom: `${R2}/neogeo/mslug.zip`,    cover: `${R2}/neogeo/covers/mslug.webp` },
    { name: 'Metal Slug 2',            rom: `${R2}/neogeo/mslug2.zip`,   cover: `${R2}/neogeo/covers/mslug2.webp` },
    { name: 'Metal Slug 3',            rom: `${R2}/neogeo/mslug3.zip`,   cover: `${R2}/neogeo/covers/mslug3.jpg` },
    { name: 'Metal Slug X',            rom: `${R2}/neogeo/mslugx.zip`,   cover: `${R2}/neogeo/covers/mslugx.jpg` },
    { name: 'Metal Slug 4',            rom: `${R2}/neogeo/mslug4.zip`,   cover: `${R2}/neogeo/covers/mslug4.jpg` },
    { name: 'Metal Slug 5',            rom: `${R2}/neogeo/mslug5.zip`,   cover: `${R2}/neogeo/covers/mslug5.jpg` },
    { name: 'KOF 94',                  rom: `${R2}/neogeo/kof94.zip`,    cover: `${R2}/neogeo/covers/kof94.jpg` },
    { name: 'KOF 95',                  rom: `${R2}/neogeo/kof95.zip`,    cover: `${R2}/neogeo/covers/kof95.jpg` },
    { name: 'KOF 96',                  rom: `${R2}/neogeo/kof96.zip`,    cover: `${R2}/neogeo/covers/kof96.jpg` },
    { name: 'KOF 97',                  rom: `${R2}/neogeo/kof97.zip`,    cover: `${R2}/neogeo/covers/kof97.jpg` },
    { name: 'KOF 98',                  rom: `${R2}/neogeo/kof98.zip`,    cover: `${R2}/neogeo/covers/kof98.jpg` },
    { name: 'KOF 99',                  rom: `${R2}/neogeo/kof99.zip`,    cover: `${R2}/neogeo/covers/kof99.webp` },
    { name: 'KOF 2000',                rom: `${R2}/neogeo/kof2000.zip`,  cover: `${R2}/neogeo/covers/kof2000.jpg` },
    { name: 'KOF 2001',                rom: `${R2}/neogeo/kof2001.zip`,  cover: `${R2}/neogeo/covers/kof2001.jpg` },
    { name: 'KOF 2002',                rom: `${R2}/neogeo/kof2002.zip`,  cover: `${R2}/neogeo/covers/kof2002.jpg` },
    { name: 'KOF 2003',                rom: `${R2}/neogeo/kof2003.zip`,  cover: `${R2}/neogeo/covers/kof2003.jpg` },
    { name: 'Fatal Fury',              rom: `${R2}/neogeo/fatfury1.zip`, cover: `${R2}/neogeo/covers/Fatal_Fury.jpg` },
    { name: 'Fatal Fury 2',            rom: `${R2}/neogeo/fatfury2.zip`, cover: `${R2}/neogeo/covers/Fatal_Fury2.jpg` },
    { name: 'Fatal Fury 3',            rom: `${R2}/neogeo/fatfury3.zip`, cover: `${R2}/neogeo/covers/Fatal_Fury3.webp` },
    { name: 'Fatal Fury Special',      rom: `${R2}/neogeo/fatfursp.zip`, cover: `${R2}/neogeo/covers/Fatal_Fury_special.webp` },
    { name: 'Real Bout Fatal Fury',    rom: `${R2}/neogeo/rbff1.zip`,    cover: '' },
    { name: 'Real Bout Fatal Fury 2',  rom: `${R2}/neogeo/rbff2.zip`,    cover: '' },
    { name: 'Real Bout Special',       rom: `${R2}/neogeo/rbffspec.zip`, cover: `${R2}/neogeo/covers/Real_Bout_Special.jpeg` },
    { name: 'Garou Mark of the Wolves',rom: `${R2}/neogeo/garou.zip`,    cover: `${R2}/neogeo/covers/Garou_Mark_of_the_Wolves.jpg` },
    { name: 'Samurai Shodown',         rom: `${R2}/neogeo/samsho.zip`,   cover: `${R2}/neogeo/covers/SamuraiShodown.webp` },
    { name: 'Samurai Shodown 2',       rom: `${R2}/neogeo/samsho2.zip`,  cover: `${R2}/neogeo/covers/Samurai_Shodown_II_NEO_GEO.webp` },
    { name: 'Samurai Shodown 3',       rom: `${R2}/neogeo/samsho3.zip`,  cover: `${R2}/neogeo/covers/samuraishodown3.jpg` },
    { name: 'Samurai Shodown 4',       rom: `${R2}/neogeo/samsho4.zip`,  cover: `${R2}/neogeo/covers/Samurai_Shodown4.jpeg` },
    { name: 'Samurai Shodown 5',       rom: `${R2}/neogeo/samsho5.zip`,  cover: `${R2}/neogeo/covers/Samurai_Shodown5.jpeg` },
    { name: 'Samurai Shodown 5 SP',    rom: `${R2}/neogeo/samsh5sp.zip`, cover: `${R2}/neogeo/covers/Samurai_Shodown_5_SP.jpeg` },
    { name: 'Art of Fighting',         rom: `${R2}/neogeo/aof.zip`,      cover: `${R2}/neogeo/covers/Art_of_Fighting_AES.webp` },
    { name: 'Art of Fighting 2',       rom: `${R2}/neogeo/aof2.zip`,     cover: `${R2}/neogeo/covers/Art_of_Fighting_2_arcade_flyer.jpg` },
    { name: 'Art of Fighting 3',       rom: `${R2}/neogeo/aof3.zip`,     cover: `${R2}/neogeo/covers/Art_of_Fighting3.jpeg` },
    { name: 'Last Blade',              rom: `${R2}/neogeo/lastblad.zip`, cover: `${R2}/neogeo/covers/Last_Blade.jpeg` },
    { name: 'Last Blade 2',            rom: `${R2}/neogeo/lastbld2.zip`, cover: `${R2}/neogeo/covers/Last_Blade2.jpeg` },
    { name: 'SVC Chaos',               rom: `${R2}/neogeo/svc.zip`,      cover: `${R2}/neogeo/covers/SVC_Chaos.jpeg` },
    { name: 'Matrimelee',              rom: `${R2}/neogeo/matrim.zip`,   cover: `${R2}/neogeo/covers/Matrimelee.jpg` },
    { name: 'Rise of the Dragons',     rom: `${R2}/neogeo/rotd.zip`,     cover: `${R2}/neogeo/covers/Rise_of_the_dragons.jpeg` },
    { name: 'Ragnagard',               rom: `${R2}/neogeo/ragnagrd.zip`, cover: `${R2}/neogeo/covers/Ragnagard.jpg` },
    { name: 'Spin Master',             rom: `${R2}/neogeo/spinmast.zip`, cover: `${R2}/neogeo/covers/spinmaster.jpg` },
    { name: 'Pulstar',                 rom: `${R2}/neogeo/pulstar.zip`,  cover: `${R2}/neogeo/covers/Pulstar.jpeg` },
    { name: 'Viewpoint',               rom: `${R2}/neogeo/viewpoin.zip`, cover: `${R2}/neogeo/covers/Viewpoint.jpeg` },
    { name: 'Galaxy Fight',            rom: `${R2}/neogeo/galaxyfg.zip`, cover: `${R2}/neogeo/covers/GalaxyFight.jpeg` },
    { name: 'Kabuki Klash',            rom: `${R2}/neogeo/kabukikl.zip`, cover: `${R2}/neogeo/covers/Kabuki_Klash.jpeg` },
    { name: 'World Heroes',            rom: `${R2}/neogeo/wh1.zip`,      cover: `${R2}/neogeo/covers/World_Heroes.webp` },
    { name: 'World Heroes 2',          rom: `${R2}/neogeo/wh2.zip`,      cover: `${R2}/neogeo/covers/World_Heroes2.jpeg` },
    { name: 'World Heroes Perfect',    rom: `${R2}/neogeo/whp.zip`,      cover: `${R2}/neogeo/covers/World_Heroes_Perfect.jpg` },
    { name: 'Double Dragon',           rom: `${R2}/neogeo/doubledr.zip`, cover: `${R2}/neogeo/covers/Double_Dragon.jpg` },
    { name: 'Burning Fight',           rom: `${R2}/neogeo/burningf.zip`, cover: `${R2}/neogeo/covers/Burning_Fight.jpeg` },
    { name: 'Mutation Nation',         rom: `${R2}/neogeo/mutnat.zip`,   cover: `${R2}/neogeo/covers/Mutation_Nation.jpeg` },
  ],
  n64: [],
}
